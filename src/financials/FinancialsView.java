                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                .addComponent(jtxtRate, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void jbtnSchedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSchedActionPerformed
    ...
    private void jbtnModelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnModelActionPerformed
       ...
       try {
           ...
           r2 = new BigDecimal(jTextField1.getText());
          // ri = new BigDecimal(jtxtRateInc.getText());
           ri = new BigDecimal(jTextField2.getText());
           t = Integer.parseInt(jtxtTerm.getText());
       }
       ...
       if (jradLoan.isSelected()) {
           ...
           while (r.compareTo (r2) <= 0) {
               Financial f = new Loan(a,r.doubleValue(),t);
               fins.add(f);
               Thread th = new Thread(f,"Loan rate: " + r);
               threads.add(th);
               r.add(ri);
           }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       // Im not sure what is trying to be done here 
       // t is already defined above 
       // String[][] t = new String[rows][2];
       ...
       //expecting an object ... 
       sched.getColumn(1).setPreferredWidth(350);
       
       if (jradLoan.isSelected()) {
           r = r1;
           while (r.compareTo (r2) <= 0) {
               Financial f = new Loan(a,r.doubleValue(),t,sched);
               fins.add(f);
               Thread th = new Thread(f,"Loan rate: " + r);
               threads.add(th);
               r.add(ri);
           ...
           JDialog dg = new JDialog();
           dg.add(sp);
           dg.setTitle("Loan Modelling Results");
           dg.setBounds(150,400,600,300);
           dg.setVisible(true);
    ...
    private javax.swing.JTextField jtxtRate2 = new JTextField();
    private javax.swing.JTextField jtxtRateInc = new JTextField();
